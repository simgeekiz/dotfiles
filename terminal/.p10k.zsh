...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=$grey
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ALWAYS_SHOW=true  # Show username@hostname always
  ...
  typeset -g POWERLEVEL9K_BATTERY_BACKGROUND=$grey
